...
"[project]/OneDrive/Desktop/Pathway-GEN-AI/app/api/generate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Pathway$2d$GEN$2d$AI$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/OneDrive/Desktop/Pathway-GEN-AI/node_modules/next/server.js [app-route] (ecmascript)");
;
// ---------------------------------------------------------
...
async function POST(request) {
    try {
        ...
        if (!idea) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Pathway$2d$GEN$2d$AI$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        let finalPrompt = MASTER_PROMPT.replaceAll("<<BRAND_NAME>>", brandName || "").replaceAll("<<IDEA>>", idea).replaceAll("<<TARGET_AUDIENCE>>", audience || "").replaceAll("<<TONE>>", tone || "").replaceAll("<<INDUSTRY>>", industry || "");
        ...
        try {
            ...
            try {
                ...
                console.error("Second JSON.parse failed, invalid JSON from model:", e2, "\nRAW (truncated):", sliced.slice(0, 400));
                return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Pathway$2d$GEN$2d$AI$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Model returned invalid JSON (parse error: Expected ',' or ']' or similar).",
                    raw: sliced
                }, {
                    status: 500
                });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Pathway$2d$GEN$2d$AI$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(parsed, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__191cc576._.js.map